...
software engineering a field around manipulating data we can find some useful metrics to improve ourselves. Unfortunately that doesnt seem to be the case. 
...
the beginning and are active regularly, also good old fashioned lines of code is still a fun high score like metric, you may not be creating good code, but atleast you are 
